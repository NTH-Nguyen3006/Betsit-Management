...
public class ContractTenantManagerJDialog extends javax.swing.JDialog implements ContractTenantManagerController {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ContractTenantManagerJDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
private void edit() {
    if (currentIndex < 0 || currentIndex >= tblContractTenantManager.getRowCount()) return;
